...
#define TRANSPORT_ACK_RETRANSMIT_TIMEOUT_MS (250U)
#endif
#ifndef TRANSPORT_FRAME_RETRANSMIT_TIMEOUT_MS
#define TRANSPORT_FRAME_RETRANSMIT_TIMEOUT_MS (250U) // Should be long enough for a whole window to be transmitted plus an ACK / NACK to get back
#endif
