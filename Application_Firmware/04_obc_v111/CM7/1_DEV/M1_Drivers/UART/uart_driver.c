...
{
    RingBuffer_Create(&uart_drivers[0].rx_buffer, 1, "UART1_RX", uart1_rx_data, UART1_BUFFER_SIZE);
    RingBuffer_Create(&uart_drivers[0].tx_buffer, 2, "UART1_TX", uart1_tx_data, UART1_BUFFER_SIZE);

    RingBuffer_Create(&uart_drivers[1].rx_buffer, 3, "UART6_RX", uart6_rx_data, UART6_BUFFER_SIZE);
    RingBuffer_Create(&uart_drivers[1].tx_buffer, 4, "UART6_TX", uart6_tx_data, UART6_BUFFER_SIZE);
