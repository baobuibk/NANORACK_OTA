...
C_SRCS += \
../1_DEV/M1_Drivers/UART/uart_driver.c 

C_DEPS += \
./1_DEV/M1_Drivers/UART/uart_driver.d 

OBJS += \
./1_DEV/M1_Drivers/UART/uart_driver.o 


# Each subdirectory must supply rules for building sources it contributes
1_DEV/M1_Drivers/UART/%.o 1_DEV/M1_Drivers/UART/%.su 1_DEV/M1_Drivers/UART/%.cyclo: ../1_DEV/M1_Drivers/UART/%.c 1_DEV/M1_Drivers/UART/subdir.mk
...
clean: clean-1_DEV-2f-M1_Drivers-2f-UART

clean-1_DEV-2f-M1_Drivers-2f-UART:
	-$(RM) ./1_DEV/M1_Drivers/UART/uart_driver.cyclo ./1_DEV/M1_Drivers/UART/uart_driver.d ./1_DEV/M1_Drivers/UART/uart_driver.o ./1_DEV/M1_Drivers/UART/uart_driver.su

.PHONY: clean-1_DEV-2f-M1_Drivers-2f-UART
