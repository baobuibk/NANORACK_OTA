...
C_SRCS += \
../1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.c 

C_DEPS += \
./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.d 

OBJS += \
./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.o 


# Each subdirectory must supply rules for building sources it contributes
1_DEV/M5_ThirdParty/BinaryScript/port/%.o 1_DEV/M5_ThirdParty/BinaryScript/port/%.su 1_DEV/M5_ThirdParty/BinaryScript/port/%.cyclo: ../1_DEV/M5_ThirdParty/BinaryScript/port/%.c 1_DEV/M5_ThirdParty/BinaryScript/port/subdir.mk
...
clean: clean-1_DEV-2f-M5_ThirdParty-2f-BinaryScript-2f-port

clean-1_DEV-2f-M5_ThirdParty-2f-BinaryScript-2f-port:
	-$(RM) ./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.cyclo ./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.d ./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.o ./1_DEV/M5_ThirdParty/BinaryScript/port/bscript_port.su

.PHONY: clean-1_DEV-2f-M5_ThirdParty-2f-BinaryScript-2f-port
